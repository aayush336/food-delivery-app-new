...
class _CheckoutViewState extends State<CheckoutView> {
  List paymentArr = [
    {"name": "Cash on delivery", "icon": "assets/image/cash.png"},
    {"name": "**** **** **** 2187", "icon": "assets/image/visa_icon.png"},
    {"name": "test@gmail.com", "icon": "assets/image/paypal.png"},
  ];
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style:
                          TextStyle(color: Tcolor.secondary_text, fontSize: 12),
                    ),
                    const SizedBox(
                      height: 8,
                    ),
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                    color:
                                        Tcolor.secondary_text.withOpacity(0.2))),
                            child: Row(
                              children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Divider(
                      color: Tcolor.secondary_text.withOpacity(0.5),
                      height: 1,
                    ),
                    const SizedBox(
                      height: 15,
